//
//  RetroDMGTilemap9CView.swift
//  Retro
//
//  Created by Glenn Hevey on 21/1/2025.
//
...
struct RetroDMGTilemap9CView: View {
    var core: RetroDMG!
    ...
    var body: some View {
        RetroDMGViewPort {
            RetroDMGTilemap9CMetalView(core: core)
        }
...
class RetroDMGTilemap9CMetalView: MTKView {
    var renderer: RetroDMGTilemap9CRenderer!
    var core: RetroDMG!
    ...
    func createRenderer(device: MTLDevice){
        renderer = RetroDMGTilemap9CRenderer(device: device, core: self.core)
        delegate = renderer
    }
}

// MARK: Renderer
class RetroDMGTilemap9CRenderer: NSObject {
...
extension RetroDMGTilemap9CRenderer: MTKViewDelegate {
    func mtkView(_ view: MTKView, drawableSizeWillChange size: CGSize) {
        view.clearColor = MTLClearColor(red: 0.804, green: 0.859, blue: 0.878, alpha: 1)
    }
    
    func draw(in view: MTKView) {
        let pixels =  core.tileMap(get9800: false)
